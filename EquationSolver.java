...
public class EquationSolver {
    public static void main(String[] args) {
        ...
        System.out.println("--- MENU GIAI PHUONG TRINH ---");
    ...
    public static void solveLinearSystem(Scanner sc) {
        System.out.println("Nhap cac he so cho he: a11*x1 + a12*x2 = b1; a21*x1 + a22*x2 = b2");
    ...
    public static void solveQuadraticEquation(Scanner sc) {
        ...
        if (a == 0) {
            // Quay lai giai phuong trinh bac nhat bx + c = 0
            if (b == 0) {
